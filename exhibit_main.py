...
def main(args):
    print("*"*50)
    print("-"*15, "Iter:{}  Version:{}".format(args.iter,args.version), "-"*15)
    print("*"*50)
    ...
    ***********************************************************************************************************
    ...
    plt.subplot(233), plt.xticks([]), plt.yticks([]), plt.imshow(image_sparse_0, cmap="gray"),   plt.title("image_sparse_0")
    plt.subplot(234), plt.xticks([]), plt.yticks([]), plt.imshow(image_sparse_1, cmap="gray"),   plt.title("image_sparse_1")
    plt.subplot(235), plt.xticks([]), plt.yticks([]), plt.imshow(image_sparse_2, cmap="gray"),   plt.title("image_sparse_2")
    plt.subplot(236), plt.xticks([]), plt.yticks([]), plt.imshow(image_pred, cmap="gray"),       plt.title("image_pred")
    plt.show()

    plt.figure()
    plt.subplot(241), plt.xticks([]), plt.yticks([]), plt.imshow(image_sparse_0, cmap="gray"),     plt.title("image_sparse_0")
    plt.subplot(242), plt.xticks([]), plt.yticks([]), plt.imshow(image_sparse_1, cmap="gray"),     plt.title("image_sparse_1")
    plt.subplot(243), plt.xticks([]), plt.yticks([]), plt.imshow(image_sparse_2, cmap="gray"),     plt.title("image_sparse_2")
    plt.subplot(244), plt.xticks([]), plt.yticks([]), plt.imshow(image_pred, cmap="gray"),         plt.title("image_pred")
    plt.subplot(245), plt.xticks([]), plt.yticks([]), plt.imshow(image_full-image_sparse_0, cmap="gray"),     plt.title("Res image_sparse_0")
    plt.subplot(246), plt.xticks([]), plt.yticks([]), plt.imshow(image_full-image_sparse_1, cmap="gray"),     plt.title("Res image_sparse_1")
    plt.subplot(247), plt.xticks([]), plt.yticks([]), plt.imshow(image_full-image_sparse_2, cmap="gray"),     plt.title("Res image_sparse_2")
    plt.subplot(248), plt.xticks([]), plt.yticks([]), plt.imshow(image_full-image_pred, cmap="gray"),         plt.title("Res image_pred")
    plt.show()
    ...
    ***********************************************************************************************************
    ...
    print("Iter_1 Image--> SSIM:{}, MSE:{}, PSNR:{}".format(ssim_1, mse_1, psnr_1))
    print("Iter_2 Image--> SSIM:{}, MSE:{}, PSNR:{}".format(ssim_2, mse_2, psnr_2))
    print("Pred Image--> SSIM:{}, MSE:{}, PSNR:{}".format(ssim_3, mse_3, psnr_3))
